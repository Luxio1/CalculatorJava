...
public class AdvancedActivity extends AppCompatActivity {
    Button button0, button1, button2, button3, button4, button5, button6, button7, button8, button9,
            ...
            buttonBracket;
    Button buttonSin, buttonCos, buttonTan, buttonProc, button_x_2, button_x_y, buttonLog,
    buttonLn, buttonSqrt;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        button_x_2 = (Button)findViewById(R.id.button_x_2);
        button_x_y = (Button)findViewById(R.id.button_x_y);
        ...
        button_x_2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                writeExpression("^2");
            }
        ...
        button_x_y.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                writeExpression("^");
                rightBracket = true;
